...
type managerTestCoordClient struct {
	showCollectionIDs func(context.Context, *rootcoordpb.ShowCollectionIDsRequest) (*rootcoordpb.ShowCollectionIDsResponse, error)
...
func (c *managerTestCoordClient) ShowCollectionIDs(ctx context.Context, req *rootcoordpb.ShowCollectionIDsRequest, opts ...grpc.CallOption) (*rootcoordpb.ShowCollectionIDsResponse, error) {
	return c.showCollectionIDs(ctx, req)
}
...
func TestManagerRequestPathLoadsMissingStartupState(t *testing.T) {
	...
	coord := &managerTestCoordClient{
		showCollectionIDs: func(ctx context.Context, req *rootcoordpb.ShowCollectionIDsRequest) (*rootcoordpb.ShowCollectionIDsResponse, error) {
			require.NotNil(t, req)
			require.Equal(t, commonpb.MsgType_ShowCollections, req.GetBase().GetMsgType())
			require.False(t, req.GetAllowUnavailable())
			return &rootcoordpb.ShowCollectionIDsResponse{
				Status: merr.Success(),
				DbCollections: []*rootcoordpb.DBCollections{
					{DbName: "db", CollectionIDs: []int64{collectionID}},
				},
			}, nil
		},
